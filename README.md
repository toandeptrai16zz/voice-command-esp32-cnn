...
##  Kiến trúc Mô hình AI (The Core Model)
...
1.  **Input:** Âm thanh thu từ Microphone (Sample rate: 22050Hz, Duration: 1s).
2.  **Preprocessing:** * Trích xuất đặc trưng MFCC (13 coefficients).
...
4.  **Output:** Phân loại ra 3 nhãn: `bat_den`, `tat_den`, `nen` (tạp âm).

> **Độ chính xác thực tế:** Mô hình đạt độ tin cậy > **98%** trên tập test và hoạt động ổn định trong môi trường phòng thực tế.
...
Lưu ý: Rút dây GPIO 0 ra khỏi GND sau khi nạp xong.
...
Nếu có đóng góp và phản hồi xin gửi về email: haquangchuong28@gmail.com